...
class AppColors {
  static const Color BASE_COLOR = Color(0xffFFB000);
  ...
  static const Color ICON_COLOR = Color(0xffb5bec8);

  static const Color GRAY = Color(0xffA7A7A7);
  static const Color GRAY2 = Color(0xff6C6C6C);

  static const Color GRAY3 = Color(0xff606E7D);

  static const Color TEXT_LIGHT = Color(0xffAEAEAE);
  ...
  static const MaterialColor APP_THEME = MaterialColor(
    ...
    <int, Color>{
      50: Color(0xFFF3EAD8),
      100: Color(0xFFF5E1B6),
      200: Color(0xFFECCC86),
      300: Color(0xFFECC05E),
      400: Color(0xFFE7B23C),
      500: Color(0xffd7a32f),
      600: Color(0xFFD59B1A),
      700: Color(0xFFB98613),
      800: Color(0xFFAF7E12),
      900: Color(0xFF8A620A),
    },
  );
}
